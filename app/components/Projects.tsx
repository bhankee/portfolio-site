...
const projects: Project[] = [
  {
    ...
    description:
      "An AI-powered portfolio feedback tool that analyzes web developer sites using GPT-4o, Lighthouse stats, and screenshot vision to deliver structured UI/UX performance insights.",
